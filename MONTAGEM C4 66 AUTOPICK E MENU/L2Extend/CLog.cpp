...
void CLog::Add(LogType type, const wchar_t* format, ...)
{
	...
	CLogAddVW_t pfCLogAddVW = (CLogAddVW_t)0x64D340;
	va_list args;
	va_start(args, format);
...
{
	typedef void (*FStackTrace)(int);
	FStackTrace(0x5B8E30)(type);
}
